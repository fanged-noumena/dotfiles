...
config.set('content.notifications.enabled', True, 'https://4channel.org')
config.set('content.notifications.enabled', True, 'https://4chan.org')
...
# for a blank page.
# Type: FuzzyUrl
c.url.default_page = 'https://weboas.is/'
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', '4':'https://4channel.org/{}/catalog', 'b':'https://ca1lib.org/s/{}', 't': 'https://cascadr.co/blogs/{}', 'az': 'https://www.amazon.com/s?k={}', 'aw': 'https://wiki.archlinux.org/?search={}', 'ub': 'https://www.urbandictionary.com/define.php?term={}', 'wp': 'https://en.wikipedia.org/wiki/{}', 'yt': 'https://www.youtube.com/results?search_query={}', 'at': 'https://alternativeto.net/browse/search?q={}' }
...
config.bind(',da', 'config-cycle content.user_stylesheets ~/solarized-everything-css/css/dark/dark-all-sites.css ""')
